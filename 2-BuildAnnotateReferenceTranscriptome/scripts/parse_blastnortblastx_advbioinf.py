...
#parse_blastn.py outfile.txt blastnortblastx anynumberofinfiles.xml
...
if blasttype=='tblastx':
	OUT.write("Query Name\tQuery Length\tSubject Name\tSubject Length\tAlignment Length\tQuery Start\tQuery End\tSubject Start\tSubject End\tQuery Sequence\tSubject Sequence\tHsp Score\tHsp Expect\tHsp Identities\tHsp Positives\tIdentity Percent Match\tPositives Percent Match\tQueryFrame\tSubjectFrame\tGaps")
